...
var allowedOrigin = "http://localhost:3333, http://49.12.231.126:3333"; // Your website domain
...
class DataServer {
    constructor(PluginsLoader, Logger) {
        ...
        this.name = "Skins&Minimap";  // Required
        this.author = "Alvariithoo"; // Required
        this.version = "1.0.0"; // Required
        this.active = true; // Required true or false
    }
