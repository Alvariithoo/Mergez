...
/*PlayerCell.prototype.updateRemerge = function () {
    ...
    var baseTtr = this.server.config.playerRecombineTime;        // default baseTtr = 30
    if (baseTtr == 0) {
        // instant merge
...
PlayerCell.prototype.onAdd = function (server) {
    // Gamemode actions
    server.gameMode.onCellAdd(this);
};

PlayerCell.prototype.onRemove = function (server) {
    var index;
